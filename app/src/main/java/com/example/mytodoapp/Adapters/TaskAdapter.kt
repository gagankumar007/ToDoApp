...
import com.example.mytodoapp.Activites.HomeActivity
import com.example.mytodoapp.databinding.LayoutTodoItemBinding
...
class TaskAdapter(private val list: MutableList<ToDoData>) : RecyclerView.Adapter<TaskAdapter.TaskViewHolder>() {
    ...
    fun setListener(listener: HomeActivity){
        this.listener = listener
    }
    class TaskViewHolder(val binding: LayoutTodoItemBinding) : RecyclerView.ViewHolder(binding.root)
